...
## Ghi chú thêm
- Khó khăn gặp phải: Ban đầu em gặp khó khăn trong việc hiểu sự khác nhau giữa threat và vulnerability.
- Cách em xử lý: Em đọc lại lý thuyết và xem ví dụ để phân biệt rõ hơn.
- Điều em học được từ bài lab: Em hiểu rõ hơn về CIA, cách phân tích rủi ro và cách sử dụng GitHub để làm việc và nộp bài.
